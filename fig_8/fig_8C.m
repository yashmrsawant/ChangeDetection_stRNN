...
load('model_stats_FREE_120fixations.mat');
...
hold on; plot(linspace(0,140,100),linspace(0,100,100),'--k'); %[free]
...
hold on; plot(linspace(0,40000,100),linspace(0,14000,100),'--k'); %[free]
...
xlabel('Model');
ylabel('Human');
sgtitle("Without change map (- stRNN output)");
